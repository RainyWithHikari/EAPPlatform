...
namespace EAPPlatform.DataAccess.VN
{
    ...
    public class DataContextFactory : IDesignTimeDbContextFactory<DataContext>
    {
        ...
        {
            return new DataContext("User Id=EAP;Password=EAP123;Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=10.52.1.24)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=SMDDB1)))", DBTypeEnum.Oracle);
        }
    }
