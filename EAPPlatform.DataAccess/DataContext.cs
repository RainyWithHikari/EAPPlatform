...
namespace EAPPlatform.DataAccess
{
    public class DataContext : FrameworkContext
    {
        ...
        public DbSet<SxHandler> sxHandler { get; set; }
        public DbSet<SxHandlerAlarm> sxHandlerAlarm { get; set; }
        public DbSet<SxHandlerAlarmSort> sxHandlerAlarmSort { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SxHandler>(entity =>
            {
                entity.HasNoKey();
            });
            modelBuilder.Entity<SxHandlerAlarm>(entity =>
            {
                entity.HasNoKey();
            });
            modelBuilder.Entity<SxHandlerAlarmSort>(entity =>
            {
                entity.HasNoKey();
            });
    ...
    public class DataContextFactory : IDesignTimeDbContextFactory<DataContext>
    {
        ...
        {
            return new DataContext("User Id=EAP;Password=EAP123;Pooling = True;Max Pool Size = 10;Min Pool Size = 1;Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.40.168)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=SMDADC)))", DBTypeEnum.Oracle);
        }
    }
