...
namespace EAPPlatform.DataAccess.GDL
{
    ...
    public class DataContextFactory : IDesignTimeDbContextFactory<DataContext>
    {
        ...
        {
            return new DataContext("User Id=EAP;Password=EAP123;Pooling = True;Max Pool Size = 10;Min Pool Size = 1;Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=192.168.10.188)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=smddb)))", DBTypeEnum.Oracle);
        }
    }
