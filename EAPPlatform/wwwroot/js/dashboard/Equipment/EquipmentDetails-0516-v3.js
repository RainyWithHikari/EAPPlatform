layui.use(['table', 'jquery', 'laydate'], function () {
    ...
    function GetStatusDetails(chartdata) {
        ...
        const result = chartdata.reduce((acc, curr) => {
            ...
            if (curr.duration.split(":")[0].includes('.')) {


                durationInMinutes = 1440; // 将小时转换为分钟并相加
            } else {
                ...
                durationInMinutes = (durationArray[0] * 60) + durationArray[1] + (durationArray[2] / 60); // 将小时转换为分钟并相加
            }
