...
import { generateAlarmTags,removeMesh,getAlarmPosition,getAlarmCone,getColorofStatus,getEQProfie, getSelectEQPname, getClickModel, getDetailData, updateCameraPosition, createNamePlate, hideNamePlate } from './accbox.js'
...
export class Factory {
    ...
    loadFactory() {
        loadGLTF('../../images/accline-0731-processed.glb').then(object => {
