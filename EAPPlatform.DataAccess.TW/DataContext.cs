...
namespace EAPPlatform.DataAccess.TW
{
    ...
    public class DataContextFactory : IDesignTimeDbContextFactory<DataContext>
    {
        ...
        {
            return new DataContext("User Id=EAP;Password=EAP123;Pooling = True;Max Pool Size = 10;Min Pool Size = 1;Data Source=(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL=TCP)(HOST=10.0.5.33)(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=TWSPC)))", DBTypeEnum.Oracle);
        }
    }
