...
namespace EAPPlatform.DataAccess.JQ
{
    ...
    public class DataContextFactory : IDesignTimeDbContextFactory<DataContext>
    {
        ...
        {
            return new DataContext("User Id=EAP;Password=EAP123;Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=tcp)(HOST=192.168.150.137)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=SMDDB1)))", DBTypeEnum.Oracle);
        }
    }
