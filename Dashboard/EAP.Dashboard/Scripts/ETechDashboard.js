...
layui.use(['table', 'jquery', 'form', 'laydate'], function () {
    ...
    const dict = {};
    addMapping("STATION_1", "Load the FH Assy")
    addMapping("STATION_2", "Plasma Treatment")
    addMapping("STATION_3", "Dispensing  & Cover Assembling")
    addMapping("STATION_4", "Auto-screwing & Altimetry")
    ...
    function GetEQPRealtimeData() {
        $.ajax({
            ...
            success: function (retdata) {
                ...
                var idlerate = retdata.idleRate;
                var loadingrate = (1 - alarmrate - idlerate) * 100;
    ...
    function GenerateStationProfileDetails(data) {
        ...
        if (data["Status"] == "Alarm") {
            ...
            objiStationCapacity.className = "fa fa-solid fa-check-circle fa-xl col-4";
            objiStationCapacity.style.color = "green";
        }
