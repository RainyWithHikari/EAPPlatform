layui.use(['table', 'jquery', 'form', 'laydate'], function () {
    ...
    function GetEQPSuccessRateByDate() {
        $.ajax({
            type: 'post',
            dataType: 'json',
            data: {
            ...
            url: 'DMaterialDashboard/GetEQPSuccessRateByDate',
            success: function (retdata) {
                var successrate = retdata.SuccessRate *1
                document.getElementById("success-rate").innerHTML = successrate.toFixed(2) + "%";
                //drawGuage("guage-data-runrate", retdata.loadingRate.toFixed(1), 100, "Loading Rate \n\n" + datetime)
    ...
    function GetEQPHisSuccessRate() {
        $.ajax({
            ...
            url: 'DMaterialDashboard/GetEQPHisSuccessRate',
            success: function (retdata) {
                var success_fail_list = retdata.success_fail_list;
