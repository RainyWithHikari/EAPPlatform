...
import { Circle } from '../effects/circle.js'

import { generateAlarmTags,removeMesh,getAlarmPosition,getAlarmCone,getColorofStatus,getEQProfie, getSelectEQPname, getClickModel, getDetailData, updateCameraPosition, createNamePlate, hideNamePlate } from './accbox_v3.js'
...
export class Factory {
    ...
    loadFactory() {
        ...
        loadGLTF(`${basePath}/Content/Scenes/accline-0731-processed.glb`).then(object => {
