...
import { FontLoader } from '../../../../three/examples/jsm/loaders/FontLoader.js' //../../three/examples/jsm/loaders/FontLoader.js
...
export class Font {
    ...
    init() {
        ...
        loader.load(`${basePath}/Scripts/js/config/font.json`, (font) => {
            this.font = font;
